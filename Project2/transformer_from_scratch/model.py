...
class TransformerEncoder(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        # --- YOUR CODE HERE ---
        # 使用 nn.ModuleList 创建一个包含 num_layers 个 EncoderBlock 的列表。
...
class TransformerDecoder(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        # --- YOUR CODE HERE ---
        # 使用 nn.ModuleList 创建一个包含 num_layers 个 DecoderBlock 的列表。
        self.layers = nn.ModuleList(
    ...
    def forward(
        ...
        # --- YOUR CODE HERE ---
        # 依次将 tgt 通过 ModuleList 中的每一个 DecoderBlock。
        for layer in self.layers:
